...
export const CAIT_DUO_LOADOUTS = {
  asiphyx: {
    ...
    risk: 'Medium',
    sprite: {
      idleStrip: '/assets/heroes/kinetic-regent-cait/stream-cait-idle-strip.png',
      idleFrames: 16,
      idleFrameWidth: 160,
      idleFrameHeight: 160,
      idleFrameRate: 8,
      attackStrip: '/assets/heroes/kinetic-regent-cait/stream-cait-attack-strip.png',
      attackFrames: 18,
      attackFrameWidth: 176,
      attackFrameHeight: 176,
      attackFrameRate: 18,
      dashStrip: '/assets/heroes/kinetic-regent-cait/stream-cait-dash-strip.png',
      dashFrames: 18,
      dashFrameWidth: 176,
      dashFrameHeight: 176,
      dashFrameRate: 20,
      jumpStrip: '/assets/heroes/kinetic-regent-cait/stream-cait-jump-strip.png',
      jumpFrames: 18,
      jumpFrameWidth: 160,
      jumpFrameHeight: 160,
      jumpFrameRate: 16,
      runStrip: '/assets/heroes/kinetic-regent-cait/stream-cait-run-strip.png',
      runFrames: 16,
      runFrameWidth: 160,
      runFrameHeight: 160,
      runFrameRate: 14,
      streamGridStrip: '/assets/heroes/kinetic-regent-cait/stream-avatar-grid-strip.png',
      streamGridFrames: 40,
      streamGridFrameWidth: 160,
      streamGridFrameHeight: 128,
      ...
      walkFrameWidth: 45,
      walkFrameHeight: 58,
      source: '/assets/source/heroes/kinetic_regent_cait/stream_avatar_pack/idle_right/spritesheet.png',
    },
    modules: [
