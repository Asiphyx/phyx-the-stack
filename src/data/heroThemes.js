export const HERO_THEMES = {
  ...
  asiphyx: {
    ...
    motto: 'Bend the battlefield. Let Cait finish it.',
    spotlight: 'Void Architect Bay',
    lore: 'Asiphyx doesn\'t fight — he reshapes the fight. Enemy attacks get redirected, countered, reflected, or converted into Cait\'s damage. He tanks what matters, marks enemy centers of gravity, and feeds Cait clean kinetic lines.',
    mechanic: 'No direct damage: gravity modules, intent flips, defensive pressure storage, Cait follow-ups, and locked-stack crit setup.',
    modes: ['Null Trial', 'Mirror Stack', 'Gravity Engine'],
  },
  codex: {
    id: 'codex',
